...
export const metadata: Metadata = {
  title: "ink-canvas",
  description:
    "Documentation for ink-canvas, a library for rendering Ink applications in the browser.",
};
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body className={`${exo2.variable} antialiased`}>
        ...
        <Layout
          navbar={navbar}
          pageMap={pageMap}
          docsRepositoryBase="https://github.com/ByteLandTechnology/ink-canvas/tree/main/docs"
          footer={null}
